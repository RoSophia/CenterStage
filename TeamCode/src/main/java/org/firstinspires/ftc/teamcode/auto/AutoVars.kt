...
object Auto {
    ...
    var longRed = LongVals(
            ...
            bPreloadStack = Vec3T(
                    ...
                    TrajCoef(Pose(-132.0, -45.5, -1.57), Vec2d(), Vec2d(20.0, 2.0), Vec2d(0.2, 0.3), 0.9, Vec2d(40.0, 40.0)),
                    TrajCoef(Pose(-132.0, -46.0, -1.57), Vec2d(30.0, 2.0), Vec2d(30.0, 2.0), Vec2d(0.2, 0.3), 0.9, Vec2d(40.0, 40.0))),
            bStackBackdrop = Vec2T(
                    TrajCoef(Pose(-129.0, 138.0, -1.57), Vec2d(0.6, 0.6), 0.9, Vec2d(0.0, 0.1)),
                    TrajCoef(Pose(-90.0, 226.0, -1.57), Vec2d(60.0, 1.57), Vec2d(40.0, -1.56), Vec2d(0.0, 0.1), 0.9, Vec2d(60.0, 60.0))),
