...
object BlueLongP {
    ...
    var bPStack = Vec3T(
            ...
            TrajCoef(
                    Pose(-136.0, 79.0, 1.57),
                    Vec2d(0.0, 3.1), Vec2d(30.0, -2.0),
                    0.8
            ),

            TrajCoef(
                    Pose(-136.0, 84.0, 1.57),
                    Vec2d(40.0, -2.0), Vec2d(40.0, -2.0),
    ...
    var bStackPos2 = TrajCoef(
            Pose(), Pose(-145.0, 73.0, 1.3),
            1.0, Vec2d(50.0, 100.0)
    )

    @JvmField
    var bAfterShaveShaveYCase = Vec3(70.0, 69.0, 68.0)

    @JvmField
    var bPAfterAfterShave = TrajCoef(
            Pose(), Pose(-116.0, 67.0, 1.3),
...
object RedLongP {
    ...
    @JvmField
    var rPutXCase = Vec4(-54.0, -67.0, -75.0, -70.0)
...
object BlueShortP {
    ...
    @JvmField
    var sbStackOffset = Pose(-0.3, -0.3, 0.0)

    @JvmField
    var sbPutOffset = Pose(-0.3, -0.3, 0.0)
...
object RedShortP {
    ...
    var srPutFromPreloadPos = TrajCoef(
            Pose(0.0, 102.0, -1.57), Vec2d(), Vec2d(),
            Vec2d(0.2, 0.8), 1.0, Vec2d(20.0, 40.0)
    )
...
object AutoVars {
    ...
    @JvmField
    var TimeoutWaitFirstStack = 1.2

    @JvmField
    var TimeoutTakeAftl = 1.5

    @JvmField
    var Min3Pixel = 0.1

    @JvmField
    var Min3PixelSpeed = 0.09

    @JvmField
    var Min2PixelSpeed = 0.27
