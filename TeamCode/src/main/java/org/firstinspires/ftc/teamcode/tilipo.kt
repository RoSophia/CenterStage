    ...
    fun runOpMode(lom: LinearOpMode, fn: Boolean) { /// TODO: dashboard.sendImage(NekoArc)
        try {
            ...
            if (controller.C1LSB == controller.JUST_PRESSED) {
                ...
                if (controller.C2LB == controller.JUST_PRESSED || controller.C1LB == controller.JUST_PRESSED) {
                ...
                if (controller.C2RB == controller.JUST_PRESSED || controller.C1RB == controller.JUST_PRESSED) {
                ...
                //if (controller.C2RT == controller.JUST_PRESSED) { clown.close() }
            ...
            tp.put("OP MODE EXCEPTION", e.stackTraceToString())
